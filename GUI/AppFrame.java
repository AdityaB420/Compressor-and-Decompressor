...
import com.mycompany.compressor_decompressor.Compressor;
import com.mycompany.compressor_decompressor.Decompressor;
...
public class AppFrame extends JFrame implements ActionListener {
    ...
    AppFrame(){
        ...
        label.setBackground(new Color(123,150,250));
        ...
        this.getContentPane().setBackground(new Color(123,150,250));
